    ...
    <div class="col-lg-10">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.projets.store') }}" method="POST" x-data="{ submitting: false }" @submit="submitting = true">
                    @csrf
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light border-0 py-2 @error('lieu') is-invalid @enderror" id="lieu" name="lieu" value="{{ old('lieu') }}" placeholder="Ex: Mandjou, Région de l'Est" required aria-required="true">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" class="form-control bg-light border-0 py-2 @error('beneficiaires') is-invalid @enderror" id="beneficiaires" name="beneficiaires" value="{{ old('beneficiaires', 0) }}" min="0" required aria-required="true">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control bg-light border-0 py-2 @error('date_debut') is-invalid @enderror" id="date_debut" name="date_debut" value="{{ old('date_debut') }}">
                            @error('date_debut') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            <label for="date_fin" class="form-label fw-bold">Date de fin (prévue ou réelle)</label>
                            <input type="date" class="form-control bg-light border-0 py-2 @error('date_fin') is-invalid @enderror" id="date_fin" name="date_fin" value="{{ old('date_fin') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control bg-light border-0 py-2 @error('description') is-invalid @enderror" id="description" name="description" rows="6" required aria-required="true">{{ old('description') }}</textarea>
                    ...
                    <div class="row g-4 mb-5">
                        <div class="col-md-6">
                            ...
                            <select class="form-select bg-light border-0 py-2 @error('statut') is-invalid @enderror" id="statut" name="statut" required aria-required="true">
                                ...
                                <option value="termine" {{ old('statut', 'termine') == 'termine' ? 'selected' : '' }}>Terminé</option>
                            </select>
                            @error('statut') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6 d-flex align-items-end pb-2">
                            <div class="form-check form-switch p-0 ms-4">
                                <input class="form-check-input" type="checkbox" role="switch" id="visible_public" name="visible_public" value="1" {{ old('visible_public', '1') == '1' ? 'checked' : '' }}>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-success rounded-pill px-5 fw-bold shadow-sm" :disabled="submitting">Créer le projet</button>
                    </div>
                </form>
            </div>
        </div>
