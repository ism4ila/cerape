    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm rounded-4">
            <div class="card-body p-4 p-md-5">
                <form action="{{ route('admin.articles.store') }}" method="POST" x-data="{ submitting: false }" @submit="submitting = true">
                    @csrf
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light border-0 py-2 @error('auteur') is-invalid @enderror" id="auteur" name="auteur" value="{{ old('auteur', 'Administration CERAPE') }}" required aria-required="true">
                    ...
                    <div class="mb-4">
                        <label for="image_url" class="form-label fw-bold">URL de l'image (couverture)</label>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control bg-light border-0 py-2 @error('contenu') is-invalid @enderror" id="contenu" name="contenu" rows="10" required aria-required="true">{{ old('contenu') }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control bg-light border-0 py-2 @error('tags') is-invalid @enderror" id="tags" name="tags" value="{{ old('tags') }}" placeholder="Cameroun, Éducation, Mandjou">
                    ...
                    <div class="mb-5">
                        ...
                        <div class="d-flex gap-4 mt-2">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="statut" id="brouillon" value="brouillon" {{ old('statut', 'brouillon') == 'brouillon' ? 'checked' : '' }}>
                                <label class="form-check-label" for="brouillon">Brouillon</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="statut" id="publie" value="publie" {{ old('statut') == 'publie' ? 'checked' : '' }}>
                                <label class="form-check-label text-success fw-bold" for="publie">Publier immédiatement</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                        ...
                        <button type="submit" class="btn btn-primary rounded-pill px-5 fw-bold shadow-sm" :disabled="submitting">Créer l'article</button>
                    </div>
                </form>
            </div>
        </div>
